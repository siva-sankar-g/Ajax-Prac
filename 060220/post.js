...
http1.open('GET', 'https://jsonplaceholder.typicode.com/users/'+id)
...
document.getElementById('password').value = 'l14ec991@';
document.getElementById('email').value = std.email;
document.getElementById('mobileno').value = std.phone;
document.getElementById('website').value = std.website;
document.getElementById('doorno').value = '1-17';
document.getElementById('street').value  = std.address.street;
document.getElementById('mandal').value = std.address.suite;
document.getElementById('district').value = std.address.city;
